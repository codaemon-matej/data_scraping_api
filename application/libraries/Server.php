...
class Server{
	function __construct($config=array()){
		...
		$instance = &get_instance();
                ...
                $config = array();
                $config["dsn"] = $instance->db->dsn;
                $config["username"] = $instance->db->username;
                $config["password"] = $instance->db->password;
	...
	*/
	public function password_credentials(){
		$users = array("user" => array("password" => 'missingmoney', 'first_name' => 'homeway', 'last_name' => 'yao'));
                //$users = array();
