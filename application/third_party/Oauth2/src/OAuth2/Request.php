...
class Request implements RequestInterface
{
    ...
    public static function createFromGlobals()
    {
        ...
        if(isset($request->headers['PHP_AUTH_PW'])) unset($request->headers['PHP_AUTH_PW']);
        if(isset($request->headers['PHP_AUTH_USER'])) unset($request->headers['PHP_AUTH_USER']);
        if(isset($request->headers['AUTHORIZATION'])) unset($request->headers['AUTHORIZATION']);
